...
const styles = StyleSheet.create({screen: {flex: 1, justifyContent: 'center', alignItems: 'center', paddingHorizontal: 18}, box: {width: '100%', maxWidth: 300, backgroundColor: colors.blue, borderWidth: 7, borderColor: colors.outline, borderRadius: 30, padding: 24, alignItems: 'center'}, title: {fontSize: 30, color: colors.white, fontFamily: 'Georgia', fontWeight: '900'}, text: {color: colors.white, fontWeight: '700', marginVertical: 15, textAlign: 'center'}, track: {width: '78%', maxWidth: 190, height: 15, borderRadius: 8, backgroundColor: colors.white, padding: 3, overflow: 'hidden'}, pill: {height: 9, width: 40, borderRadius: 5, backgroundColor: colors.darkBlue}});
